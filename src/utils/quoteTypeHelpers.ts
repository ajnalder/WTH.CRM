...
// Prepare data for database insertion - now returns exact Supabase insert type
export const prepareQuoteForInsert = (quoteData: Partial<Quote>, userId: string): QuoteInsertData => {
  ...
  // Return data that matches Supabase's exact insert expectations
  return {
    ...
    gst_amount: 0,
    total_amount: 0,
    quote_number: '', // Will be auto-generated by database trigger
    public_link_token: null // Will be auto-generated by database default
  };
};
