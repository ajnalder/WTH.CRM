...
import { Home, Folder, Calendar, Settings, BarChart3, CheckSquare, Building2, LogOut, ClipboardList, Receipt, Rocket, Lightbulb, Globe, Mail, FileText } from 'lucide-react';
