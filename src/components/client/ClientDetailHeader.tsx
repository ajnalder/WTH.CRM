...
const ClientDetailHeader = ({
  ...
  // Use the stored avatar from the database, fallback to generated initials only if no avatar exists
  const displayAvatar = clientAvatar || clientCompany.substring(0, 2).toUpperCase();
